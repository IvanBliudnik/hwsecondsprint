...
export const pureAddUserCallback = (name: string, setUsers: Dispatch<React.SetStateAction<UserType[]>>, users: UserType[]) => { // need to fix any
    const user:UserType = {
        _id: v1(),
       name,
    }
    const newUser: UserType[] = [...users, user]
            setUsers(newUser)
}
